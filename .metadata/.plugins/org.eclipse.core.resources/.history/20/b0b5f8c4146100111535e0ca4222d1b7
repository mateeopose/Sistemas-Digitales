...
#define ntc_GPIO_Port GPIOD
#define potBajo_Pin GPIO_PIN_12
#define potAlto_Pin GPIO_PIN_13
#define potMedio_Pin GPIO_PIN_15
#define pot_GPIO_Port GPIOD
#define MascaraLeds ntcAlto_Pin|ntcBajo_Pin|ntcMedio_Pin|potBajo_Pin|potAlto_Pin|potMedio_Pin
#define MascaraApagarLeds (ntcAlto_Pin|ntcBajo_Pin|ntcMedio_Pin|potBajo_Pin|potAlto_Pin|potMedio_Pin) << 16*/
/* ENTRADAS (Sensores en Puerto A) */
#define ntc_Pin GPIO_PIN_2
#define pot_Pin GPIO_PIN_4
#define sensores_IN_Port GPIOA

/* SALIDAS (LEDs en Puerto D) */
#define ntcAlto_Pin GPIO_PIN_8
#define ntcBajo_Pin GPIO_PIN_9
#define ntcMedio_Pin GPIO_PIN_11
#define potBajo_Pin GPIO_PIN_12
#define potAlto_Pin GPIO_PIN_13
#define potMedio_Pin GPIO_PIN_15
#define leds_OUT_Port GPIOD

/* MÁSCARAS (Con nombres en mayúscula) */
#define MASCARA_ENCENDER_LEDS (ntcAlto_Pin|ntcBajo_Pin|ntcMedio_Pin|potBajo_Pin|potAlto_Pin|potMedio_Pin)
#define MASCARA_APAGAR_LEDS ((ntcAlto_Pin|ntcBajo_Pin|ntcMedio_Pin|potBajo_Pin|potAlto_Pin|potMedio_Pin) << 16)
/* USER CODE BEGIN PD */
...
// Tamaño del buffer a implementar
...
// Valor promedio de las muestras del potenciómetro
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOD, ntcAlto_Pin|ntcBajo_Pin|ntcMedio_Pin|poteBajo_Pin
                          |poteAlto_Pin|poteAltoD15_Pin|Audio_RST_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : ntcAlto_Pin ntcBajo_Pin ntcMedio_Pin poteBajo_Pin
                           poteAlto_Pin poteAltoD15_Pin Audio_RST_Pin */
...
// Apaga todos los LED, usando el registro BSRR del puerto
// Apaga todos los LED, usando el registro BSRR del puerto
void apagarTodos(void){
	leds_OUT_Port->BSRR = MASCARA_APAGAR_LEDS;
}
// Enciende todos los LED, usando el registro BSRR del puerto
void encenderTodos(void){
	leds_OUT_Port->BSRR = MASCARA_ENCENDER_LEDS;
}
...
// Realizamos la suma incrementando el puntero a las muestras
...
// Como el termistor es NTC, a mayor valor muestreado, menor valor de temperatura.
// Si se supera el límite inferior, el rango es bajo
if (NTC_INFERIOR < ntc_avg) {
 // Encendemos el LED verde
 HAL_GPIO_WritePin( leds_OUT_Port, ntcBajo_Pin, GPIO_PIN_SET);
 HAL_GPIO_WritePin( leds_OUT_Port, ntcMedio_Pin, GPIO_PIN_RESET);
 HAL_GPIO_WritePin( leds_OUT_Port, ntcAlto_Pin, GPIO_PIN_RESET);
}
// Si no se supera el límite superior, el rango es alto
else if (NTC_SUPERIOR > ntc_avg) {
 // Encendemos el LED rojo
 HAL_GPIO_WritePin( leds_OUT_Port, ntcBajo_Pin, GPIO_PIN_RESET);
 HAL_GPIO_WritePin( leds_OUT_Port, ntcMedio_Pin, GPIO_PIN_RESET);
 HAL_GPIO_WritePin( leds_OUT_Port, ntcAlto_Pin, GPIO_PIN_SET);
}
// En otro caso, el rango es medio
else {
 // Encendemos el LED amarillo
 HAL_GPIO_WritePin( leds_OUT_Port, ntcBajo_Pin, GPIO_PIN_RESET);
 HAL_GPIO_WritePin( leds_OUT_Port, ntcMedio_Pin, GPIO_PIN_SET);
 HAL_GPIO_WritePin( leds_OUT_Port, ntcAlto_Pin, GPIO_PIN_RESET);
}
}
// Maneja los LED de rango para el potenciómetro
void mostrarPot(void){
// Si no se supera el límite inferior, el rango es bajo
if (POT_INFERIOR > pot_avg) {
 // Encendemos el LED verde
 HAL_GPIO_WritePin( leds_OUT_Port, potBajo_Pin, GPIO_PIN_SET);
 HAL_GPIO_WritePin( leds_OUT_Port, potMedio_Pin, GPIO_PIN_RESET);
 HAL_GPIO_WritePin( leds_OUT_Port, potAlto_Pin, GPIO_PIN_RESET);
}
// Si se supera el límite superior, el rango es alto
else if (POT_SUPERIOR < pot_avg) {
 // Encendemos el LED rojo
 HAL_GPIO_WritePin( leds_OUT_Port, potBajo_Pin, GPIO_PIN_RESET);
 HAL_GPIO_WritePin( leds_OUT_Port, potMedio_Pin, GPIO_PIN_RESET);
 HAL_GPIO_WritePin( leds_OUT_Port, potAlto_Pin, GPIO_PIN_SET);
}
// En otro caso, el rango es medio
else {
 // Encendemos el led amarillo
 HAL_GPIO_WritePin( leds_OUT_Port, potBajo_Pin, GPIO_PIN_RESET);
 HAL_GPIO_WritePin( leds_OUT_Port, potMedio_Pin, GPIO_PIN_SET);
 HAL_GPIO_WritePin( leds_OUT_Port, potAlto_Pin, GPIO_PIN_RESET);
}
}
